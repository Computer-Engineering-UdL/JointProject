...
class CheckInViewTest(TestCase):
    ...
    def setUp(self):
        ...
        self.reservation = RoomReservation.objects.create(id=5, room=room, entry='2021-01-01', exit='2021-01-02',
                                                          num_guests=2)
        self.client_obj = Client.objects.create(id_number='12345678A', first_name='John', last_name='Doe',
                                                email='client@gmail.com', phone_number='123456789', is_hosted=False)
